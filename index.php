...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-6 col-md-6">
            <div class="thumbnail">
                <!-- imagem curso -->
                <img src="assets/img/<?php echo $infosCurso['image']; ?>"
                ...
                <div class="caption">
                    ...
                    <a href="#" class="btn btn-info" data-toggle="modal"
                        data-target="#<?php echo $infosCurso['tag']; ?>" role="button">Comprar</a>
                </div>
            </div>
        </div>
        <?php endforeach; ?>
        <?php foreach ($cursos as $key => $infosCurso) : ?>
        <<<<<<< HEAD <div class="modal fade" id="<?php echo $infosCurso['tag']; ?>" role="dialog">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <<<<<<< HEAD <h4> Curso de: <?php echo $infosCurso['nome']; ?> </h4>
                                    <h4> Preço: R$ <?php echo $infosCurso['preco']; ?> </h4>
                                    <form action="validarCompra.php" method="post">
                                        <input type="hidden" name="nomeCurso"
                                            value="<?php echo $infosCurso['nome']; ?>">
                                        <input type="hidden" name="precoCurso"
                                            value="<?php echo $infosCurso['preco']; ?>">
